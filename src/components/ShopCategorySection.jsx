  ...
  return (
    <>
      <section className="">
        ...
        <div className="grid grid-cols-[repeat(2,1fr)] gap-3 overflow-x-auto p-1 md:grid-cols-[repeat(4,minmax(200px,260px))] xl:grid-cols-[repeat(auto-fit,minmax(200px,260px))]">
          {!showSkeleton ? (
            <>
